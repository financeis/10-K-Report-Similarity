...
- **방향이 없는 관계에 맞춘 배치:** 경쟁사는 위쪽 호, 공급·협력은 아래쪽 호, 지분만 있는 회사는 오른쪽에 둡니다.
  - 여러 관계인 회사는 점 하나로 그리고, 위치는 공급·협력 > 경쟁 > 지분 순으로 정합니다. 관계마다 선을 하나씩 나란히 긋고, 마우스를 올리면 관계 목록이 뜹니다.
  - 공급사 왼쪽·고객 오른쪽 배치(8.2)는 방향을 묻지 않기로 해서 쓰지 않습니다.
- **화면 다듬기 (2026-09-26):**
  - 위·아래 호는 가로로 늘린 같은 궤도(점선 타원) 위에 놓고 양옆을 비워 구역을 가릅니다. 한 호에 16곳이 넘으면 두 줄, 36곳이 넘으면 세 줄입니다.
  - 선은 가운데 쪽으로 옅어지게 그립니다. 점 크기는 근거 문장 수입니다 (선 굵기는 여전히 일정).
  - 점에 마우스를 올리면 그 회사의 관계만 남기고 흐리게 합니다. 누르면 근거가 오른쪽에 나오고, 두 번 누르면 그 회사로 갑니다.
  - 확대·축소·전체 보기·크게 보기·PNG 저장 도구, 밝은·어두운 화면, 첫 화면의 관계도 미리보기를 넣었습니다.
